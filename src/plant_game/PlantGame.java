...
public class PlantGame {
     ...
     */
    private void newGame() throws MoneyException, FileNotFoundException {

        System.out.print("Please enter your player name:");
        //Reads the first word entered and dumps the rest so no names with spaces 
        String name = scan.next();
        scan.nextLine();
        //Create player object
        setPlayer(files.newPlayer(name));
     ...
     */
    private void previousGame() throws IOException, FileNotFoundException, FileLoadErrorException, InstantiationException, IllegalAccessException {

        try {

            //loads the last game.
            files.loadCurrentGame();
            //Loads variables from file.
            setPlayer(files.loadPlayer());
            setShop(files.readShop());
            setUnlocks(files.readUnlock());
     ...
     * @throws FileLoadErrorException
     */
    private void loadGame() throws IOException, FileNotFoundException, FileLoadErrorException, MoneyException, InstantiationException, IllegalAccessException {
        //Stores user input
        int anwser = 0;
        //Finds current save files
        String[] array = files.saveDisplay();
    ...
    private void save() throws IOException {
        ...
        files.saveCurrentGame(getShop(), getUnlocks(), getPlayer());
        //Stores user input
        int saveslot = 0;
        ...
        if (saveFiles[saveslot - 1].contains("null")) {
            ...
            files.saveGame(getShop(), getUnlocks(), getPlayer(), saveslot);
            //success message.
    ...
    public void start() {
        ...
        try {
                            ...
                            while (x != 9) {
                                try {
                                    ...
                                    switch (x) {
                                        case 1: {
                                            //general information
                                            ArrayList<String> plants = files.information("Information");
                                            plants.forEach(i -> {
                                                System.out.println(i);
                                            });
                                            System.out.println("");
                                        ...
                                        case 2: {
                                            //plant information
                                            ArrayList<String> plants = files.information("plants");
                                            plants.forEach(i -> {
                                                System.out.println(i);
                                            });
                                            System.out.println("");
                                        ...
                                        case 3: {
                                            //plant a plant info
                                            ArrayList<String> plants = files.information("Plant a Plant");
                                            plants.forEach(i -> {
                                                System.out.println(i);
                                            });
                                            System.out.println("");
                                        ...
                                        case 4: {
                                            //pick a plant info
                                            ArrayList<String> plants = files.information("Pick Plant");
                                            plants.forEach(i -> {
                                                System.out.println(i);
                                            });
                                            System.out.println("");
                                        ...
                                        case 5: {
                                            //water a plant info
                                            ArrayList<String> plants = files.information("Water");
                                            plants.forEach(i -> {
                                                System.out.println(i);
                                            });
                                            System.out.println("");
                                        ...
                                        case 6: {
                                            //next day info
                                            ArrayList<String> plants = files.information("Next day");
                                            plants.forEach(i -> {
                                                System.out.println(i);
                                            });
                                            System.out.println("");
                                        ...
                                        case 7: {
                                            //unlock info
                                            ArrayList<String> plants = files.information("Unlock");
                                            plants.forEach(i -> {
                                                System.out.println(i);
                                            });
                                            System.out.println("");
                                        ...
                                        case 8: {
                                            //Save game info
                                            ArrayList<String> plants = files.information("Save game");
                                            plants.forEach(i -> {
                                                System.out.println(i);
                                            });
                                            System.out.println("");
            ...
            System.out.println(endline);
            //Saves highscore
            files.saveHighScore(getHighscores(), getPlayer());
            setHighscores((OrderedList<Score>) files.loadHighScore());
            //Print highscores
